...
void            BoltSceneNode::BoltRenderNode::render()
{
    ...
    if (drawBillboardShot)
    {
        ...
        else if (BZDBCache::blend)
        {
            ...
            batch5.color4fv(mainColor);
            batch5.vertex2fv(core[1]);
            batch5.color4fv(outerColor);
            ...
            batch6.color4fv(innerColor);
            batch6.vertex2fv(core[0]);
            batch6.color4fv(mainColor);
        ...
        else
        {
            ...
            batch8.color4fv(innerColor);
            batch8.vertex2fv(core[0]);
            batch8.color4fv(mainColor);
